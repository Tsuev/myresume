    ...
    portfolioCards: [
      {
        ...
        title: 'B2B & B2C',
        description: 'TC Badr',
        experience : 'Дороботал имеющийся проект компании, разработал админку для проекта, после перенес на svelte по просьбе заказчика. Практически полностью выполнен мной',
      ...
      },
      {
        ...
        experience : 'Разрабатывал отдельные компоненты. А также провел часть работы по админке данного проекта.',
        link: 'https://edu95.ru/',
        fullImg: 'edufull.png'
      }
    ],
